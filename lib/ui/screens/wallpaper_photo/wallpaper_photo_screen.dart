...
import '/ui/common/controls/checkbox.dart';
import '/ui/wonder_illustrations/common/animated_clouds.dart';
...
class _WallpaperPhotoScreenState extends State<WallpaperPhotoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    WonderIllustrationConfig fgConfig = const WonderIllustrationConfig(
      enableAnims: false,
      enableHero: false,
      enableBg: false,
    );
