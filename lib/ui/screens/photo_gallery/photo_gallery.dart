...
import '/ui/common/controls/app_loading_indicator.dart';
import '/ui/common/controls/eight_way_swipe_detector.dart';
import '/ui/common/hidden_collectible.dart';
import '/ui/common/modals/fullscreen_url_img_viewer.dart';
  ...
  Widget _buildImage(int index, Duration swipeDuration, Size imgSize) {
    ...
    return ValueListenableBuilder(
        ...
        builder: (_, __, ___) {
          ...
          final imgIdx = _photoIds.value.indexOf(imgUrl);
                    ...
                    : ClipRRect(
                        ...
                        child: SizedBox(
                          ...
                          child: TweenAnimationBuilder<double>(
                            ...
                            child: Image.asset(
                                'assets/images/patches/${(imgIdx % 4) + 1}.png'),
