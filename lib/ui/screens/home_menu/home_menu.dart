...
import '/ui/common/app_backdrop.dart';
import '/ui/common/app_icons.dart';
import '/ui/common/controls/app_header.dart';
import '/ui/common/controls/locale_switcher.dart';
import '/ui/common/pop_navigator_underlay.dart';
import '/ui/screens/home_menu/about_dialog_content.dart';
    ...
    return SeparatedColumn(
      ...
      children: [
        buildRow([
          ...
          // // make it [2]
          // _buildGridBtn(context, wondersLogic.all[2 % 2]),
        ]),
        buildRow([
          // _buildGridBtn(context, wondersLogic.all[3 % 2]),
          SizedBox(
              width: _btnSize(context) * 3,
              child: Image.asset(
              ...
              // SvgPicture.asset(SvgPaths.compassFull,
              //     colorFilter: $styles.colors.offWhite.colorFilter),
              ),
          // _buildGridBtn(context, wondersLogic.all[4 % 2]),
        ]),
        buildRow([
          // _buildGridBtn(context, wondersLogic.all[5 % 2]),
          // _buildGridBtn(context, wondersLogic.all[6 % 2]),
          _buildGridBtn(context, wondersLogic.all[7 % 2]),
        ]),
      ],
    );
  }
