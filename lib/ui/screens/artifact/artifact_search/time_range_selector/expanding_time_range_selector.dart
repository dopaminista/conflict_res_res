...
import '/ui/common/opening_card.dart';
import '/ui/common/wonders_timeline_builder.dart';
import '/ui/screens/artifact/artifact_search/artifact_search_screen.dart';
import '/ui/screens/artifact/artifact_search/time_range_selector/range_selector.dart';
import '/ui/screens/artifact/artifact_search/time_range_selector/time_range_painter.dart';
        ...
        SizedBox(
          ...
          child: Stack(children: [
            ...
            Positioned.fill(
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: RangeSelector.handleWidth),
            ...
            Positioned.fill(
              child: RangeSelector(
                key: const ValueKey('RangeSelectorIsWonderTime'),
